...
extension ViewStyle where Self: UIView {
    ...
    @discardableResult func shadow(color: UIColor = UIColor.black, radius: CGFloat = 1.0 ,shadowOffset : CGSize = CGSize(width: 1.0, height: 1.0) , shadowOpacity : Float = 0.7) -> Self {
